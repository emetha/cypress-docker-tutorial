...
In our case, we have chosen to build from version 4.4.0 of `cypress/included`, this is to make sure that Cypress executes tests as soon as its container starts up. 
